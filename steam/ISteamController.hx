...
@:native("ISteamController")
extern class ISteamController
{
  ...
  //public inline function GetConnectedControllers():Array<ControllerHandle_t>
  //{
    //untyped __cpp__(
  //}
  
  //@:native('GetConnectedControllers')
  //private function _GetConnectedControllers(RawPointer<ControllerHandle_t>):Int;
